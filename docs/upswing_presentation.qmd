...
-   There are not enough dates, e.g. the sliding period contains 7 days instead of 8 days (at the beginning and end of the evaluation time period).
...
::: incremental
-   Most forecasters are good at detecting surges overall but not good at detecting when a surge is an upswing.
...
![](images/Screen%20Shot%202022-03-21%20at%2012.13.11%20PM.png){.fragment .fade-in-then-out fig-align="left" width="347"}
